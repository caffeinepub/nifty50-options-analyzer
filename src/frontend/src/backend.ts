...
export class Backend implements backendInterface {
    ...
    async addAnalysis(arg0: AnalysisInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addAnalysis(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAnalysisHistory(): Promise<Array<Analysis>> {
        if (this.processError) {
            try {
    ...
    async storePreferences(arg0: Preferences): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storePreferences(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
