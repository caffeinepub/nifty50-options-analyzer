...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        sans: ['GeneralSans', 'Segoe UI', 'sans-serif'],
      ...
      colors: {
        ...
        teal: {
          ...
          50: "oklch(0.95 0.03 187)",
          100: "oklch(0.90 0.06 187)",
          400: "oklch(0.82 0.10 187)",
          500: "oklch(0.785 0.115 187)",
          600: "oklch(0.70 0.10 187)",
        },
      ...
      boxShadow: {
        ...
        glow: "0 0 20px rgba(55,214,197,0.2)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
